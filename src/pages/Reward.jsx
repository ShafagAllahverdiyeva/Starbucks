    ...
    <section className="rewards">
      ...
      <div className="earn__star">
        ...
        <div className="box">
          ...
          <div className="box1">
            <img src="https://www.starbucks.com/weblx/images/rewards/getting-started/getting-started-2@2x.jpg" alt="image not found" />
          ...
          <div className="box1">
            <img src="https://www.starbucks.com/weblx/images/rewards/getting-started/getting-started-3@2x.jpg" alt="image not found" />
      ...
      <div className="endless__extras">
        ...
        <div className="box">
          <div className="box1">
            <img src="https://www.starbucks.com/weblx/images/rewards/benefits/1-fun-freebies.jpg" alt="image not found" />
            <h2>Fun freebies</h2>
            <p>
          ...
          <div className="box1">
            <img src="https://www.starbucks.com/weblx/images/rewards/benefits/2-order-and-pay-ahead.jpg" alt="image not found" />
          ...
          <div className="box1">
            <img src="https://www.starbucks.com/weblx/images/rewards/benefits/3-get-to-free-faster.jpg" alt="image not found" />
